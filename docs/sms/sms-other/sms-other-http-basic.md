...
|          |                                     |
| -------- | ----------------------------------- |
| Host     | \<host\>.httpsms.api.sinch.com |
...
**Correct Settings**
```shell
$ curl -v “http://eu3.httpsms.api.sinch.com:3800/sendsms?username=user&password=pass&from=CLX&to=46700 123456&text=Test”
* About to connect() to eu3.httpsms.api.sinch.com port 3800 (#0)
*           Trying 93.158.78.4â€¦ connected
* Connected to eu3.httpsms.api.sinch.com (93.158.78.4) port 3800 (#0)
> GET /sendsms?username=user&password=pass&from=CLX&to=46700123456&text=Test HTTP/1.1
> User-Agent: curl/7.19.7 (universal-apple-darwin10.0) libcurl/7.19.7 OpenSSL/0.9.8l zlib/1.2.3
> Host: eu3.httpsms.api.sinch.com:3800
> Accept: */*
>
...
* Connection #0 to host eu3.httpsms.api.sinch.com left intact
...
**Wrong Settings**
```shell
$ curl -v “http://eu3.httpsms.api.sinch.com:3800/sendsms?username=user&password=pass&from=CLX&to=46700 123456&mclass=123&text=Test”
* About to connect() to eu3.httpsms.api.sinch.com port 3800 (#0)
*           Trying 93.158.78.4â€¦ connected
* Connected to eu3.httpsms.api.sinch.com (93.158.78.4) port 3800 (#0)
...
| Variable     | Value                                            |
| ------------ | ------------------------------------------------ |
| http-API URL | <http://eu3.httpsms.api.sinch.com:3800/sendsms>?      |
| username     | userX                                            |
| password     | passX                                            |
| from         | Test                                             |
| to           | 123456                                           |
...
```shell
http://eu3.httpsms.api.sinch.com:3800/sendsms?username=userX&password=passX&from=test&to=123456&text=Hello+world
```
...
| <http://eu3.httpsms.api.sinch.com:3800/sendsms>                                       | http-API URL                                                                                                                           |
...
```shell
http://eu3.httpsms.api.sinch.com:3800/sendsms?username=userX&password=passX&from=test&to=123456&text=Hello+world&dlr-mask=7&dlr-url=http%3a%2f%2fyour.host.com%2fdlr.php%3ftype%3d%25d%26dr-%c2%admsg%3d%25A
...
**Example**
```shell
http://eu3.httpsms.api.sinch.com:3800/sendsms?username=userX&password=passX&from=test&to=123456&text=Hello+world&alt-dcs=1&mclass=0
...
**Not URL-Encoded**
```shell
http://eu3.httpsms.api.sinch.com:3800/sendsms?username=userX&password=passX&from=test&to=123456&text=??????+???&coding=2
...
**URL-Encoded**
```shell
http://eu3.httpsms.api.sinch.com:3800/sendsms?username=userX&password=passX&from=test&to=123456&text=%D0%BF%D1%80%D0%B8%D0%B2%D0%B5%D1%82%20%D0%BC%D0%B8%D1%80&coding=2
...
To receive the MO message Sinch needs a URL that specifies where the messages should be sent (To update the Deliver_SM Url, please contact your Sinch account manager). The URL will be passed as HTTP1.1 GET request. Sinch need:
