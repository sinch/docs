...
The following WhatsApp URLs can be used by the WhatsApp API. We have servers in the US and EU. Link related to the region in which the Sender ID has been provisioned should be used. Note, those URLs cannot be used interchangeably.
