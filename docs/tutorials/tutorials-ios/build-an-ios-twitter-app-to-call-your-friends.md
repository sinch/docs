...
One feature you might want to add to this app is Managed Push. ([Learn more about Managed Push with SinchService](doc:voice-ios-push-notifications-callkit)) You can also find more Sinch tutorials on the [Sinch tutorial site](https://developers.sinch.com/docs/tutorials-introduction) or on [Sinch’s GitHub](https://github.com/sinch). Of course, you can also find us on Twitter [@SinchDev](https://twitter.com/sinchdev).
